...
import kr.co.api.backend.dto.search.SearchResultItemDTO;
import kr.co.api.backend.dto.search.SearchResultResponseDTO;
import kr.co.api.backend.dto.search.SectionResultDTO;
import kr.co.api.backend.mapper.SearchMapper;
